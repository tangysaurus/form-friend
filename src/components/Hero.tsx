...
// Remove onGetStarted prop, use useNavigate directly
const Hero = () => {
    const navigate = useNavigate(); // Initialize useNavigate

    const handleGetStarted = () => {
        navigate("/health-stats"); // Navigate to the health stats form
    };
    ...
    return (
        <div className="relative min-h-screen bg-gradient-to-br from-blue-900 via-purple-900 to-indigo-900 flex items-center justify-center overflow-hidden">
            ...
            <div className="relative z-10 max-w-6xl mx-auto px-6 text-center">
                ...
                <Button 
                    onClick={handleGetStarted} // Call local handleGetStarted
                    size="lg" 
